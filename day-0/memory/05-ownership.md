...
> **Примечание:** Утечки в Rust возможны (циклы `Rc`, `mem::forget`), но случайно их сделать сложно. Rust защищает от типичных ошибок, а не от всех.
